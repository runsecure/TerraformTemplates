...
# Additional data volumes - formatted (ext4) and mounted under /mnt/dataN
# by cloud-init (see scripts/cloud-init.yaml.tftpl).
...
resource "aws_volume_attachment" "data" {
  ...
  device_name = "/dev/sd${substr("fghijklmnop", count.index, 1)}"
